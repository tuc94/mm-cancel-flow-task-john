...
export default function FlowShell({
  ...
  return (
    <div className="min-h-screen bg-neutral-800/80 p-6">
      <div className="mx-auto max-w-5xl overflow-hidden rounded-2xl border border-black/5 bg-white shadow-2xl">
        {/* Header */}
        ...
        {/* Body: left = injected step content, right = image */}
        <div className="grid gap-6 p-6 md:grid-cols-2">
          <div className="md:pr-2">{children}</div>
